# Project: Performance comparison between PouchDB and MySQL
...
## Usage
  ...
  * C:\CSDL\PouchDB source code> nodemon server (or node server) <br/>
  ...
  When node server has started, you can open our project in VScode, check out our api and run&test queries by postman <br />
